      ...
      <div class="content-fluid p-5 shadow mb-5 bg-white e7" style="background:#fff;border-radius:15px;">
        ...
        <nav class="mt-4">
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-riles-tab" data-bs-toggle="tab" data-bs-target="#nav-riles" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Riles</button>
            </div>
        </nav>
