...
<body>
    <?php include("modals/libres/agregar.php");?>
    <?php include("modals/libres/editar.php");?>
    <?php include("modals/libres/eliminar.php");?>
    <?php include('nav.php');?>
    ...
    <div id="content">
      <div class="content-fluid p-5 shadow mb-5 bg-white e7" style="background:#fff;border-radius:15px;">
        <div class="d-flex justify-content-between e3">
          <h3>Días Libres</h3>
          <a href="php/acciones/report/report_libres.php" target="_blank" class="btn btn-primary agregar e6">
            <img src="img/iconos/pdf.svg" alt="" style="width:34px; margin-right: 14px;"> Exportar
          </a>
        </div>

        <div class="row d-flex justify-content-end mt-5 e3">
          <div class="e8">
