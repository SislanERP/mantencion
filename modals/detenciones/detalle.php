<form id="guardarDetalle">
    <div class="modal fade" id="dataDetalle" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="col">
                            ...
                            <div class="form-group mb-0 d-flex align-items-center">
                                ...
                                <div class="form-check ml-3">
                                    <input class="form-check-input" type="radio" name="detencion_proceso0" id="detencion_proceso1" value="1" checked>
                                    <label class="form-check-label" for="detencion_proceso1">
                                        Sí
                                    </label>
                                </div>
                                <div class="form-check ml-3">
                                    <input class="form-check-input" type="radio" name="detencion_proceso0" id="detencion_proceso2" value="0">
