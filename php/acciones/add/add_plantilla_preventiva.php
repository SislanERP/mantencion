<?php
	...
	{ 
        $query="UPDATE plantilla_preventiva SET detalle='$_POST[summernote]',fec_edicion='$fecha', id_usuario_edicion=$id_usuario where id_equipo=$_POST[equipo]";
    ...
    else
    {
        ...
        $query="INSERT INTO plantilla_preventiva (id_plantilla,id_equipo,detalle,fec_registro,id_usuario_registro) values($contador,$_POST[equipo],'$_POST[summernote]','$fecha',$id_usuario)";
        if (conectar()->query($query) === TRUE) 
        {
