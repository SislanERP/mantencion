      ...
      <div class="content-fluid p-5 shadow mb-5 bg-white e7" style="background:#fff;border-radius:15px;">
        ...
        <nav class="mt-4">
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-camara-tab" data-bs-toggle="tab" data-bs-target="#nav-camara" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Reporte</button>
            </div>
        </nav>
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-camara" role="tabpanel" aria-labelledby="nav-camara-tab">
                <div class="camara mt-3 d-flex flex-column">
