...
?>
              ...
              <table class="table align-items-center table-flush"
                ...
                data-url="ajax/consulta_libres.php">
                
                <thead class="bg-primary text-light">
                  <tr>
                        <th data-field="id" data-sortable="true" data-visible="false" data-print-ignore="true">N°</th>
                        <th data-field="usuario" data-sortable="true" data-visible="true">Trabajador</th>
                        <th data-field="estado" data-sortable="true" data-visible="true">Estado</th>
                        <th data-field="fecha_trabajada" data-sortable="true">Fecha Trabajada</th>
                        <th data-field="fecha_pagada" data-sortable="true">Fecha Pagada</th>
<?php 
                      if($edit == 1 || $delete == 1)
                      {
?>
...
?>
          return [
            '<a class="text-primary" href="#" data-toggle="modal" data-target="#dataUpdate" data-id="'+ row['id'] +'" data-id_usuario="'+ row['id_usuario'] +'" data-nombre="'+ row['usuario'] +'" data-fecha_trabajada="'+ row['fecha_trabajada'] +'" title="Editar">',
              '<i class="fas fa-pencil-alt pr-1" style="font-size:20px;"></i>',
            '</a>  ',
            '<a class="text-danger" href="#" data-toggle="modal" data-target="#dataDelete" data-id="'+ row['id'] +'" data-nombre="'+ row['usuario'] +'" data-fecha="'+ row['fecha_trabajada'] +'" title="Remove">',
