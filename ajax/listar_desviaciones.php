			...
			while($row = mysqli_fetch_array($query)){
				...
				<tr>
					...
					<td>
                        ...
                        <button type="button" class="btn p-0" data-toggle="modal" data-target="#dataResponder" data-id="<?php echo $row['id']?>" data-desviacion="<?php echo $row['desviacion']?>" data-consecuencia="<?php echo $row['consecuencia']?>" data-acciones="<?php echo $row['acciones']?>" data-responsable="<?php echo $row['responsable']?>" data-observaciones="<?php echo $row['observaciones']?>" data-estado="<?php echo $row['id_estado']?>" data-ejecucion="<?php echo $row['ejecucion']?>" data-fec_ejecucion="<?php echo $row['fec_ejecucion']?>" data-area="<?php echo $area?>"><img src="img/iconos/ver.svg" alt="" class="btn-accion align-self-center" style="width:34px;"></button>
