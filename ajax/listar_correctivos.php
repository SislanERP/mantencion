<?php
    ...
    if($action == 'ajax'){
		...
		$tables="	correctivos a inner JOIN
					prioridades b on a.id_prioridad = b.id_prioridad inner JOIN
		...
		$campos="	a.fec_inicio as fecha,
                    ...
                    a.ot_padre as ot_padre,
                    f.nombre as responsable,
					d.nombre as usuario,
					a.id_correctivo as id,
		...
		$sWhere=" a.fec_inicio LIKE '%".$query."%' or d.nombre LIKE '%".$query."%' or c.equipo LIKE '%".$query."%' or a.id_correctivo='".$query."' or g.estado='".$query."'";
		$sWhere.=" order by a.id_correctivo desc";
