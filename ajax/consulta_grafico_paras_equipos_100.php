<?php 
    ...
    else
    {
        ...
        else
        {
            ...
            $consulta = "call consulta_grafico_equipos_100($año, $mes_inicial,$mes_final)";
            ...
            while ($columna = mysqli_fetch_array( $resultado ))
            {
                ...
                else
                {
                    ...
                    echo $_SESSION['paras'];
                    $hora_produccion = $_SESSION['paras'];
                    $minutosTotales1= ($hora_produccion * 60) + $hora_produccion;
            ...
            $color = json_encode($c);
                ...
                echo "
                    <script>
                    var MeSeContext = document.getElementById('myChart2').getContext('2d');
                    var MeSeData = {
                        labels: $ubicacion,
                        datasets: [{
                            label: 'Porcentaje',
