					...
					<td>
						<?php
								...
								{ 
									if($columna['editar'] == 1){
						?>
										<button type="button" class="btn p-0" data-toggle="modal" data-target="#dataUpdate" data-id="<?php echo $row['id']?>" data-fecha="<?php echo $row['fecha']?>" data-equipo="<?php echo $row['id_equipo']?>" data-frecuencia="<?php echo $row['id_frecuencia']?>" data-estado="<?php echo $row['id_estado'];?>"><img src="img/iconos/editar.svg" alt="" class="btn-accion align-self-center" style="width:34px;"></button>
						<?php
									}else{
						?>
										<button type="button" class="btn p-0" data-toggle="modal" data-target="#dataUpdate" data-id="<?php echo $row['id']?>" data-fecha="<?php echo $row['fecha']?>" data-equipo="<?php echo $row['id_equipo']?>" data-frecuencia="<?php echo $row['id_frecuencia']?>" data-estado="<?php echo $row['id_estado'];?>" disabled><img src="img/iconos/editar.svg" alt="" class="btn-accion align-self-center" style="width:34px;"></button>
						<?php
									}
						?>
						<?php
