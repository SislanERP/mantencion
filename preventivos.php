          ...
          <div class="card shadow pr-3 pl-3">
            <div class="resultado">
              ...
              <table class="table align-items-center table-flush"
                ...
                data-url="ajax/listar_preventivos.php">
                ...
                <thead class="bg-primary text-light">
                  <tr>
                        ...
                        <th data-field="trabajador" data-sortable="true">Responsable</th>
...
?>
  ...
  <?php include('modals/preventivo/editar.php')?>
  <?php include('modals/preventivo/eliminar.php')?>
  ...
  <script>
    ...
    function operateFormatter(value, row, index) {
        var reporte = "php/acciones/report/report_preventivo.php?id=" + row['id'];
<?php
        if($edit == 1 && $delete == 1)
        {
?>
          return [
            '<a class="text-primary" href="#" data-toggle="modal" data-target="#dataUpdate" data-id="'+ row['id'] +'" data-fecha="'+ row['fecha'] +'" data-prioridad="'+ row['id_prioridad'] +'" data-responsable="'+ row['id_trabajador'] +'" data-estado="'+ row['id_estado'] +'" title="Editar">',
